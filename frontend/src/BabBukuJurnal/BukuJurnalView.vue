                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive mt-2">
                      ...
                      >
                        ...
                        <tbody>
                          <tr
                            v-for="(post, index) in babbukujurnals"
                            :key="post.id"
                          >
...
export default {
  mounted() {
    axios.get("http://localhost:8080/api/bukujurnal").then((response) => {
      this.babbukujurnals = response.data.jurnal;
