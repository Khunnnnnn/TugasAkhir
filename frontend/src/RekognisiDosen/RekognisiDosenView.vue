      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Rekognisi Dosen Page</h1>
              </div>
              <div class="col-sm-6">
                      ...
                      >
                        ...
                        <tbody>
                          ...
                          >
                            ...
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">
                              {{ post.bidang_keahlian }}
                            </td>
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">
                              {{ post.deskripsi_bukti }}
                            </td>
                            <td>
                            ...
                            <td
                              ...
                              data-b-a-s="thin"
                            >
                              <div v-if="post.tingkat == 'nasional'">
                                {{ "✓" }}
                              </div>
                            </td>
                            <td
                              ...
                              data-b-a-s="thin"
                            >
                              <div v-if="post.tingkat == 'internasional'">
                                {{ "✓" }}
                              </div>
                            </td>
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">
...
export default {
  mounted() {
    axios.get("http://localhost:8080/api/rekogdosen").then((response) => {
      this.rekognisidosens = response.data.rekog;
    ...
    PostDelete(id, index) {
      this.$swal({
        ...
        if (result.isConfirmed) {
          // <-- if confirmed
          axios
            .delete(`http://localhost:8080/api/rekognisidosens/${id}`)
            .then((response) => {
