...
export default {
  ...
  methods: {
    PostStore(e) {
      ...
      axios
        .post('http://localhost:8080/api/kepuasanmahasiswa', formData)
        .then((response) => {
      ...
      // if (!this.kepmhs.title) {
      //   this.errors.push(errors.titlevue, "Masukkan Title kepmhs.");
      // }

      // if (!this.kepmhs.content) {
      //   this.errors.push("Masukkan Konten kepmhs.");
      // }
