      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Sertifikat Dosen Page</h1>
              </div>
              <div class="col-sm-6">
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive mt-2">
                      ...
                      >
                        ...
                        <tbody>
                          <tr
                            v-for="(post, index) in sertifkompdosens"
                            :key="post.id"
                          >
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">{{ post.nama_sertifikat }}</td>
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">{{ post.keterangan }}</td>
                            <td>
...
export default {
  mounted() {
    axios.get("http://localhost:8080/api/sertifikatdosen").then((response) => {
      this.sertifkompdosens = response.data.sertif;
