      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Riwayat Pendidikan Dosen Page</h1>
              </div>
              <div class="col-sm-6">
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive mt-2">
                      ...
                      >
                        ...
                        <tbody>
                          <tr
                            v-for="(post, index) in ripendosens"
                            :key="post.id"
                          >
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">{{ post.tahun_lulus }}</td>
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">{{ post.riwayat_pendidikan }}</td>
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">{{ post.perguruan_tinggi }}</td>
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">{{ post.jurusan }}</td>
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">{{ post.program_studi }}</td>
...
export default {
  mounted() {
    axios.get("http://localhost:8080/api/ripendosen").then((response) => {
      this.ripendosens = response.data.ripen;
