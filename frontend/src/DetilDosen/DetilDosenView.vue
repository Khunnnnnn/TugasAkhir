      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Detil Dosen Dosen Page</h1>
              </div>
              <div class="col-sm-6">
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive mt-2">
                      ...
                      >
                        ...
                        <tbody>
                          <tr
                            v-for="(post, index) in detildosens"
                            :key="post.id"
                          >
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">{{ post.bidang_keahlian }}</td>
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">{{ post.kesesuaian }}</td>
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">{{ post.jabatan_akademik }}</td>
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">{{ post.no_sertif_pendidik }}</td>
                            <td data-b-a-s="thin" data-t="s" data-a-h="center">{{ post.perusahaan }}</td>
                            <td>
...
export default {
  mounted() {
    axios.get("http://localhost:8080/api/detildosen").then((response) => {
      this.detildosens = response.data.detil;
